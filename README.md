...
* **🚀 多引擎万能爬虫架构（Universal Multi-Engine Spider）**：
  * 内置集成 **王二小牛娃猫源**（`9988`）、**豆源**（`2333`）、以及统一控制网关（`9980`）。
...
| 文件类型 | 说明 | 适用场景 |
| :--- | :--- | :--- |
| **`CatPawPlayer_v1.0.0_Setup.exe`** | 现代图形化安装向导，支持自定义路径、桌面快捷方式 | 推荐大多数用户使用，支持覆盖更新升级 |
| **`CatPawPlayer_v1.0.0_Portable.zip`** | 绿色免安装解压即用版 | 适合便携 U 盘或快速体验 |
